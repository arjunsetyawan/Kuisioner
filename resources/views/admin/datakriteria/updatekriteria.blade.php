...
@section('container')
    <div class="container-fluid">
        <h1 class="h3 mb-2 text-gray-800">Update Data Kriteria</h1>
        <p class="mb-4"></p>
                    ...
                    <form class="col-lg-8" method="post" action="/datakriteria/update/{{ $data->id_kriteria }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kriteria" name="kriteria" required
                                value="{{ old('kriteria', $data->kriteria) }}" autofocus>
                            @error('kriteria')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="textarea" class="form-control" id="detail_kriteria" name="detail_kriteria"
                                value="{{ old('detail_kriteria', $data->detail_kriteria) }}" required>
