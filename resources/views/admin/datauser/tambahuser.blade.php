            ...
            <div class="table-responsive">
                <form class="col-lg-8" method="post" action="/datauser/tambah">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama" name="nama" required value="{{ old('nama') }}" autofocus>
                        @error('nama')
                    ...
                    <div class="mb-3">
                        <input type="password" class="form-control" id="password" name="password" required value="{{$password}}" hidden>
                    </div>
                    <div class="mb-3">
