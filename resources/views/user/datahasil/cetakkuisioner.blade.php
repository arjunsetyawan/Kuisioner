...
<body>
        ...
        <table class="static" align="center" rules="all" border="1px" style="width:95%;">
            <thead>
                <tr>
                    ...
                    <th rowspan="2" style="width: 20%" class="text-center">Kriteria</th>
    ...
    <p style="margin-left:40px; margin-top:30px;"><b>Keterangan</b></p>
    <p style="margin-left:40px; ">9-12 : Sangat Baik</p>
    <p style="margin-left:40px; ">6-9 : Baik</p>
    <p style="margin-left:40px; ">3-6 : Cukup</p>
    <p style="margin-left:40px; ">1-3 : Kurang</p>
