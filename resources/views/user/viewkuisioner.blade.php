                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn btn-primary mt-4 mb-5 me-3 " data-bs-toggle="modal" data-bs-target="#submit">Selesai</button>
                                    </div>

                                    {{-- MODAL SUBMIT --}}
                                    <div class="modal fade" id="submit" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
